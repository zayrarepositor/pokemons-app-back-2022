...
/* BEFORE DEPLOY, POSTGRES CONFIG DATA IN .ENV=>
DB_USER=postgres
DB_PASSWORD=password
DB_HOST = localhost: 5432
AND HERE WE EXTRACT THEM=> 
const { DB_USER, DB_PASSWORD, DB_HOST } = process.env; 
TO USE IT IN SEQUELIZE INITIALIZATION=>
...
// Aca vendrian las relaciones. En este caso de muchos a muchos
